...
import 'package:foundit/resources/Custom%20CSC%20picker/dropdown_with_search.dart';
...
class CSCPicker extends StatefulWidget {
  ...
  const CSCPicker({
    ...
    this.countryLabelWidget,
    this.cityLabelWidget,
    this.stateLabelWidget,
  });
  ...
  final Widget? countryLabelWidget, cityLabelWidget, stateLabelWidget;
...
class CSCPickerState extends State<CSCPicker> {
  ...
  Future<dynamic> getResponse() async {
    var res = await rootBundle
        .loadString('lib/resources/Custom CSC picker/assets/country.json');
      ...
      children: [
        ...
        widget.layout == Layout.vertical
            ? Column(
                ...
                //! DESIGN HERE
                children: <Widget>[
                  widget.countryLabelWidget ?? const SizedBox.shrink(),
                  countryDropdown(),
                  SizedBox(
                    height: 10.0,
                  ),
                  widget.stateLabelWidget ?? const SizedBox.shrink(),
                  stateDropdown(),
                  SizedBox(
                    height: 10.0,
                  ),
                  widget.cityLabelWidget ?? const SizedBox.shrink(),
                  cityDropdown()
                ],
              )
            : Column(
